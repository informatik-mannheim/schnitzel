  ...
  def execute(os)
    ...
    begin
      ...
      if !passed
        ...
        motivation = WRONG_SOLUTION_MOTIVATION[rand(0..WRONG_SOLUTION_MOTIVATION.length)-1].strip.split("\n").map(&:strip)
      ...
      praise = CORRECT_SOLUTION_PRAISES[rand(0..CORRECT_SOLUTION_PRAISES.length)-1]
