#!/usr/bin/env ruby
# Generator for the file chaos.tar.xz used by the schnitzel game
require 'fileutils'
...
puts "Patching 16_find.rb"
patch_file('../src/exercises/16_find.rb', /CHAOS_TXT_FILE_COUNT = \d+/, "CHAOS_TXT_FILE_COUNT = #{NUM_TXT_FILES}")
